...
func chanSeekerFuncNok(out chan<- io.Seeker, act func() (io.Seeker, bool)) {
	defer close(out)
	for {
...
func ChanSeekerFuncNok(act func() (io.Seeker, bool)) (out <-chan io.Seeker) {
	cha := make(chan io.Seeker)
	go chanSeekerFuncNok(cha, act)
	return cha
}

func chanSeekerFuncErr(out chan<- io.Seeker, act func() (io.Seeker, error)) {
	defer close(out)
	for {
