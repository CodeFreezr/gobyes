...
// Complex64Pile is a hybrid container for
...
// p.Next() keeps traverses the Complex64Pile.
//
...
// MakeComplex64Pile returns a (pointer to a) fresh pile
// of items (of type `complex64`)
...
func (d *Complex64Pile) Done() (done <-chan []complex64) {
	...
	go func(cha chan<- []complex64, d *Complex64Pile) {
		defer close(cha)
		d.offset = 0
