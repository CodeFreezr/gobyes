...
// FileInfoPile is a hybrid container for
...
// p.Next() keeps traverses the FileInfoPile.
//
...
// MakeFileInfoPile returns a (pointer to a) fresh pile
// of items (of type `os.FileInfo`)
...
func (d *FileInfoPile) Done() (done <-chan []os.FileInfo) {
	...
	go func(cha chan<- []os.FileInfo, d *FileInfoPile) {
		defer close(cha)
		d.offset = 0
