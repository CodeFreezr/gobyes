...
// SeekerPile is a hybrid container for
...
// p.Next() keeps traverses the SeekerPile.
//
...
// MakeSeekerPile returns a (pointer to a) fresh pile
// of items (of type `io.Seeker`)
...
func (d *SeekerPile) Done() (done <-chan []io.Seeker) {
	...
	go func(cha chan<- []io.Seeker, d *SeekerPile) {
		defer close(cha)
		d.offset = 0
