...
// ReadSeekerPile is a hybrid container for
...
// p.Next() keeps traverses the ReadSeekerPile.
//
...
// MakeReadSeekerPile returns a (pointer to a) fresh pile
// of items (of type `io.ReadSeeker`)
...
func (d *ReadSeekerPile) Done() (done <-chan []io.ReadSeeker) {
	...
	go func(cha chan<- []io.ReadSeeker, d *ReadSeekerPile) {
		defer close(cha)
		d.offset = 0
