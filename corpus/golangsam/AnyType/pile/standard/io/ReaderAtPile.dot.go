...
// ReaderAtPile is a hybrid container for
...
// p.Next() keeps traverses the ReaderAtPile.
//
...
// MakeReaderAtPile returns a (pointer to a) fresh pile
// of items (of type `io.ReaderAt`)
...
func (d *ReaderAtPile) Done() (done <-chan []io.ReaderAt) {
	...
	go func(cha chan<- []io.ReaderAt, d *ReaderAtPile) {
		defer close(cha)
		d.offset = 0
