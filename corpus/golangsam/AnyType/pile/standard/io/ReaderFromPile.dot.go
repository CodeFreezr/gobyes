...
// ReaderFromPile is a hybrid container for
...
// p.Next() keeps traverses the ReaderFromPile.
//
...
// MakeReaderFromPile returns a (pointer to a) fresh pile
// of items (of type `io.ReaderFrom`)
...
func (d *ReaderFromPile) Done() (done <-chan []io.ReaderFrom) {
	...
	go func(cha chan<- []io.ReaderFrom, d *ReaderFromPile) {
		defer close(cha)
		d.offset = 0
