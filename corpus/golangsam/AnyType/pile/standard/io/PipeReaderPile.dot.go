...
// PipeReaderPile is a hybrid container for
...
// p.Next() keeps traverses the PipeReaderPile.
//
...
// MakePipeReaderPile returns a (pointer to a) fresh pile
// of items (of type `*io.PipeReader`)
...
func (d *PipeReaderPile) Done() (done <-chan []*io.PipeReader) {
	...
	go func(cha chan<- []*io.PipeReader, d *PipeReaderPile) {
		defer close(cha)
		d.offset = 0
