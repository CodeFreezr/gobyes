...
// ByteReaderPile is a hybrid container for
...
// p.Next() keeps traverses the ByteReaderPile.
//
...
// MakeByteReaderPile returns a (pointer to a) fresh pile
// of items (of type `io.ByteReader`)
...
func (d *ByteReaderPile) Done() (done <-chan []io.ByteReader) {
	...
	go func(cha chan<- []io.ByteReader, d *ByteReaderPile) {
		defer close(cha)
		d.offset = 0
