...
func chanByteWriterFuncNok(out chan<- io.ByteWriter, act func() (io.ByteWriter, bool)) {
	defer close(out)
	for {
...
func ChanByteWriterFuncNok(act func() (io.ByteWriter, bool)) (out <-chan io.ByteWriter) {
	cha := make(chan io.ByteWriter)
	go chanByteWriterFuncNok(cha, act)
	return cha
}

func chanByteWriterFuncErr(out chan<- io.ByteWriter, act func() (io.ByteWriter, error)) {
	defer close(out)
	for {
...
func ChanByteWriterFuncErr(act func() (io.ByteWriter, error)) (out <-chan io.ByteWriter) {
	cha := make(chan io.ByteWriter)
	go chanByteWriterFuncErr(cha, act)
	return cha
}
